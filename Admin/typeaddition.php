...
$sql=mysqli_query($conn,"SELECT * FROM tbl_type WHERE type='$typename'");
		...
		{
$sql=mysqli_query($conn,"INSERT INTO tbl_type(type,Description)VALUES('$typename','$typedescription')");
