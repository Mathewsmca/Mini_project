...
<div class="container" style="width:100%;margin-left: margin-bottom: 14%;padding-top:8%" >
    <div class="row">
    ...
    <br>
     ...
     <div class="row">
      <input type="submit" name="btnsubmit" value="Login" class="btn btn-primary" style="margin-left:80%;background-color: #CBC3E3;">
    </div>
    <br>
     </div>
</div>
