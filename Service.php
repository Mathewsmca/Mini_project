    ...
    <section>
        <div class="container">
            <div class="text-center">
                ...
                <p class="lead">Need a ride? Dont worry, we are here for you</p>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="courses-thumb courses-thumb-secondary">
                        ...
                        <div class="courses-detail">
                            ...
                            <p class="lead"><small>from</small> <strong>$100</strong> <small></small></p>
                            <p>car lies between a luxury and an affordable .</p>
                        </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="courses-thumb courses-thumb-secondary">
                        ...
                        <div class="courses-detail">
                            ...
                            <p class="lead"><small>from</small> <strong>$50</strong> <small></small></p>
                            <p>Automobile with one or more rows of folding or removable seats behind the driver.</p>
                        </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="courses-thumb courses-thumb-secondary">
                        ...
                        <div class="courses-detail">
                            ...
                            <p class="lead"><small>from</small> <strong>$80</strong> <small></small></p>
                            <p>Improve the countries environmental status along with maintaining public mobility needs.</p>
                        </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="courses-thumb courses-thumb-secondary">
                        ...
                        <div class="courses-detail">
                            ...
                            <p class="lead"><small>from</small> <strong>$20</strong> <small></small></p>
                            <p> cars designed for low-cost purchase and operation..</p>
                        </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="courses-thumb courses-thumb-secondary">
                        ...
                        <div class="courses-detail">
                            ...
                            <p class="lead"><small>from</small> <strong>$10</strong> <small></small></p>
                            <p>models for sale to suit all budgets, tastes, and lifestyles..</p>
                        </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="courses-thumb courses-thumb-secondary">
                        ...
                        <div class="courses-detail">
                            <h3><a href="fleet.html">Large: Premium</a></h3>
                            <p class="lead"><small>from</small> <strong>$150</strong> <small></small></p>
                            <p>Luxury cars often use higher-quality interior materials and have features.</p>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="footer-info">
                        ...
                        <address>
                                   <p>7012597675</p>
                                   <p><a href="mailto:contact@company.com">contact</a></p>
                              </address>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" id="contact-form">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="country">Pick-up Location</label>
                                <input type="text" class="form-control" placeholder="Pick-up location" required>
                            </div>

                            <div class="col-md-6">
                                <label for="country">Return location</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="country">Pick-up date/time</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="country">Enter phone</label>
